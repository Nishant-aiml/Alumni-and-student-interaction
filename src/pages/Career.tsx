          ...
          <div className="flex-1">
            ...
            <Tab.Group>
              <div className="border-b border-gray-200 overflow-x-auto">
                <Tab.List className="flex space-x-4 min-w-max px-2">
                  <Tab
                    className={({ selected }) =>
                      `${
                        selected
                  ...
                  >
                    <Briefcase className="h-5 w-5 mr-2 md:mr-1" />
                  ...
                  >
                    <FileText className="h-5 w-5 mr-2 md:mr-1" />
                  ...
                  >
                    <Users className="h-5 w-5 mr-2 md:mr-1" />
                  ...
                  >
                    <GraduationCap className="h-5 w-5 mr-2 md:mr-1" />
